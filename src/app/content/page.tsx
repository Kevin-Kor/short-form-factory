    ...
    return (
        <div className="space-y-8">
            <div className="flex justify-between items-center">
                <h1 className="text-3xl font-bold text-accent">내 콘텐츠</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loading ? (
                    <p className="text-muted col-span-full text-center py-10">로딩 중...</p>
                ) : contents.length === 0 ? (
                    <div className="col-span-full text-center py-10 bg-white rounded-xl border border-border">
                        ...
                        <p className="text-muted mb-4">진행 중인 프로젝트가 없습니다.</p>
                        <Link href="/order">
                    ...
                    contents.map((item) => (
                        <div key={item.id} className="bg-white rounded-xl overflow-hidden border border-border group shadow-sm hover:shadow-md transition-all">
